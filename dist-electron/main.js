...
FormData$1.prototype._multiPartHeader = function(field, value, options2) {
  ...
  if (typeof options2.header === "object") {
    populate$1(headers, options2.header);
  }
  var header;
...
FormData$1.prototype._getContentDisposition = function(value, options2) {
  ...
  if (typeof options2.filepath === "string") {
    filename = path$1.normalize(options2.filepath).replace(/\\/g, "/");
  } else if (options2.filename || value && (value.name || value.path)) {
    filename = path$1.basename(options2.filename || value && (value.name || value.path));
...
FormData$1.prototype.submit = function(params, cb) {
  ...
  if (typeof params === "string") {
    ...
    options2 = populate$1(params, defaults2);
    if (!options2.port) {
...
function createWindow() {
  ...
  win = new BrowserWindow({
    ...
    webPreferences: {
      ...
      // Manter contextIsolation: true e nodeIntegration: false para segurança
